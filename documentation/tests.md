...
Current automated result: `pnpm test` (20), `pnpm typecheck`, and `pnpm build` (includes `dist/noteferry-companion.zip` without a system `zip`) pass after `0.1.7` customer README and English listing description.
